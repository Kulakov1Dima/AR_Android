...
import com.common.helpers.DepthSettings;
...
public class ARFrame extends AppCompatActivity implements SampleRender.Renderer {
    ...
    String png = "models/Cube.png";
    String obj = "models/untitled.obj";
    ...
    public void onSurfaceCreated(SampleRender render) {
        ...
        try {
            ...
            virtualObjectMesh = Mesh.createFromAsset(render, obj);
            virtualObjectMesh.scaleVertices(0.5f);
